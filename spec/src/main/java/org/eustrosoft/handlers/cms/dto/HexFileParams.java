...
public class HexFileParams {
    ...
    public HexFileParams(String destination, String recordId, String recordVer, String filePid, String hex, String crc32, String description,
                         Integer securityLevel, Long chunkNumber, Long chunkCount, Long chunkSize) {
